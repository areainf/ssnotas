...
class OrganismosControllerTest < ActionController::TestCase
  ...
  test "should create organismo" do
    assert_difference('Organismo.count') do
      post :create, organismo: { codigo: @organismo.codigo, descripcion: @organismo.descripcion, nombre: @organismo.nombre }
    end
  ...
  test "should update organismo" do
    put :update, id: @organismo, organismo: { codigo: @organismo.codigo, descripcion: @organismo.descripcion, nombre: @organismo.nombre }
    assert_redirected_to organismo_path(assigns(:organismo))
  end
