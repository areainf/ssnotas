...
class PersonasControllerTest < ActionController::TestCase
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post :create, persona: { apellido: @persona.apellido, email: @persona.email, nombre: @persona.nombre }
    end
  ...
  test "should update persona" do
    patch :update, id: @persona, persona: { apellido: @persona.apellido, email: @persona.email, nombre: @persona.nombre }
    assert_redirected_to persona_path(assigns(:persona))
  end
